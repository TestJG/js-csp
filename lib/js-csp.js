(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    define('csp', [], factory);
  else if (typeof exports === 'object') exports['csp'] = factory();
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__buffers__ = __webpack_require__(
          2
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__boxes__ = __webpack_require__(
          1
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(
          15
        );
        ...
        class Channel {
          ...
          put(value, handler) {
            ...
            if (this.closed) {
              handler.commit();
              return new __WEBPACK_IMPORTED_MODULE_1__boxes__['a' /* Box */](
                false
              );
            }
            ...
            if (this.buf && !this.buf.isFull()) {
              handler.commit();
              const done = __webpack_require__.i(
                __WEBPACK_IMPORTED_MODULE_2__utils__['a' /* isReduced */]
            ...
            while (this.takes.length > 0) {
              ...
              if (taker.isActive()) {
                ...
                // flow-ignore
                __webpack_require__.i(
                  __WEBPACK_IMPORTED_MODULE_2__utils__['b' /* taskScheduler */]
                )(taker.commit(), value);
                return new __WEBPACK_IMPORTED_MODULE_1__boxes__['a' /* Box */](
                  true
                );
            ...
            if (handler.isBlockable()) {
              ...
              this.puts.unboundedUnshift(
                new __WEBPACK_IMPORTED_MODULE_1__boxes__['b' /* PutBox */](
                  handler,
                  value
                )
              );
            ...
            if (this.buf && this.buf.count() > 0) {
              ...
              while (this.puts.length > 0 && !this.buf.isFull()) {
                ...
                if (putter.handler.isActive()) {
                  ...
                  )(putter.handler.commit(), true);

                  // flow-ignore
                  if (
                    __webpack_require__.i(
                      __WEBPACK_IMPORTED_MODULE_2__utils__['a' /* isReduced */]
                    )(this.xform['@@transducer/step'](this.buf, putter.value))
                  ) {
                    this.close();
                  }
                }
          ...
          close() {
            ...
            __webpack_require__.i(
              __WEBPACK_IMPORTED_MODULE_2__utils__['c' /* flush */]
            )(this.takes, taker => {
              if (taker.isActive()) {
                __webpack_require__.i(
                  __WEBPACK_IMPORTED_MODULE_2__utils__['b' /* taskScheduler */]
        ...
        function chan(buf, xform, exHandler) {
          ...
          return new Channel(
            __webpack_require__.i(
              __WEBPACK_IMPORTED_MODULE_0__buffers__['e' /* ring */]
            )(32),
            __webpack_require__.i(
              __WEBPACK_IMPORTED_MODULE_0__buffers__['e' /* ring */]
            )(32),
 ...
 */
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function(setImmediate) {
          ...
          /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__handlers__ = __webpack_require__(
            7
          );
          /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__instruction__ = __webpack_require__(
            13
          );
          /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__boxes__ = __webpack_require__(
            1
          );
          /* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__channels__ = __webpack_require__(
            0
          );
          /* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dispatch__ = __webpack_require__(
            4
          );

          const NO_VALUE = '@@process/NO_VALUE';
          /* unused harmony export NO_VALUE */

          function putThenCallback(channel, value, callback) {
            const result = channel.put(
              value,
              new __WEBPACK_IMPORTED_MODULE_1__handlers__['a' /* FnHandler */](
                true,
                callback
              )
            );
          ...
          function take(channel) {
            return new __WEBPACK_IMPORTED_MODULE_2__instruction__[
              'a' /* TakeInstruction */
            ](channel);
          }
          ...
          function offer(channel, value) {
            ...
            return result instanceof
              __WEBPACK_IMPORTED_MODULE_3__boxes__['a' /* Box */];
          }
            ...
            run(state) {
              if (!this.finished) {
                ...
                if (done) {
                  ...
                  value instanceof
                  __WEBPACK_IMPORTED_MODULE_2__instruction__[
                    'a' /* TakeInstruction */
                  ]
                ) {
                  ...
                  __webpack_require__.i(
                    __WEBPACK_IMPORTED_MODULE_5__dispatch__[
                      'a' /* queueDelay */
                    ]
                  )(this.schedule, value.msec);
                } else if (
                  value instanceof
                  __WEBPACK_IMPORTED_MODULE_2__instruction__[
                    'd' /* AltsInstruction */
                  ...
                  __webpack_require__.i(
                    __WEBPACK_IMPORTED_MODULE_0__select__['a' /* doAlts */]
                  )(value.operations, this.schedule, value.options);
                } else if (
                  value instanceof
                  __WEBPACK_IMPORTED_MODULE_4__channels__['b' /* Channel */]
                ) {
          ...
          /* harmony export (immutable) */ __webpack_exports__['i'] = Process;
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function(setImmediate) {
          ...
          const tasks = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_0__buffers__['e' /* ring */]
          )(32);
          let running = false;
          let queued = false;
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__impl_buffers__ = __webpack_require__(
          2
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__impl_process__ = __webpack_require__(
          3
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_channels__ = __webpack_require__(
          0
        );

        function spawn(gen) {
          const ch = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_2__impl_channels__['c' /* chan */]
          )(
            __webpack_require__.i(
              __WEBPACK_IMPORTED_MODULE_0__impl_buffers__['a' /* fixed */]
            )(1)
          );
          const process = new __WEBPACK_IMPORTED_MODULE_1__impl_process__[
            'i' /* Process */
          ](gen, value => {
            if (
              value ===
              __WEBPACK_IMPORTED_MODULE_2__impl_channels__['a' /* CLOSED */]
            ) {
              ch.close();
            } else {
              __webpack_require__.i(
                __WEBPACK_IMPORTED_MODULE_1__impl_process__[
                  'g' /* putThenCallback */
                ]
              )(ch, value, () => ch.close());
            }
        ...
        function chan(bufferOrNumber, xform, exHandler) {
          ...
          return __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_2__impl_channels__['c' /* chan */]
          )(bufferOrNumber, xform, exHandler);
        }
        ...
        function promiseChan(xform, exHandler) {
          return __webpack_require__.i(
            ...
            __webpack_require__.i(
              __WEBPACK_IMPORTED_MODULE_0__impl_buffers__['d' /* promise */]
            )(),
            xform,
            exHandler
          );
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__channels__ = __webpack_require__(
          0
        );
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_noop__ = __webpack_require__(
          25
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_noop___default = __webpack_require__.n(
          __WEBPACK_IMPORTED_MODULE_0_lodash_noop__
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__boxes__ = __webpack_require__(
          1
        );
        ...
        class FnHandler {
          constructor(blockable, func) {
            ...
            this.func = func ||
              __WEBPACK_IMPORTED_MODULE_0_lodash_noop___default.a;
          }
      ...
      /***/ function(module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function(global) {
          ...
          exports.setImmediate = (typeof self !== 'undefined' &&
            self.setImmediate) ||
            (typeof global !== 'undefined' && global.setImmediate) ||
            (this && this.setImmediate);
          exports.clearImmediate = (typeof self !== 'undefined' &&
            self.clearImmediate) ||
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_times__ = __webpack_require__(
          27
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_times___default = __webpack_require__.n(
          __WEBPACK_IMPORTED_MODULE_0_lodash_times__
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__impl_boxes__ = __webpack_require__(
          1
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_channels__ = __webpack_require__(
          0
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__impl_process__ = __webpack_require__(
          3
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__csp_core__ = __webpack_require__(
          5
        );
          ...
          return {
            ...
            take(handler) {
              const result = ch.take({
                ...
                commit() {
                  ...
                  return value =>
                    takeCallback(
                      value ===
                        __WEBPACK_IMPORTED_MODULE_2__impl_channels__[
                          'a' /* CLOSED */
                        ]
                        ? __WEBPACK_IMPORTED_MODULE_2__impl_channels__[
                            'a' /* CLOSED */
              ...
              if (result) {
                ...
                return new __WEBPACK_IMPORTED_MODULE_1__impl_boxes__[
                  'a' /* Box */
                ](
                  value ===
                    __WEBPACK_IMPORTED_MODULE_2__impl_channels__[
        ...
        function filterFrom(p, ch, bufferOrN) {
          const out = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
          )(bufferOrN);

          __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['b' /* go */]
          )(function*() {
            for (;;) {
              const value = yield __webpack_require__.i(
                __WEBPACK_IMPORTED_MODULE_3__impl_process__['b' /* take */]
              )(ch);
              if (
                value ===
                __WEBPACK_IMPORTED_MODULE_2__impl_channels__['a' /* CLOSED */]
              ...
              if (p(value)) {
                yield __webpack_require__.i(
                  __WEBPACK_IMPORTED_MODULE_3__impl_process__['a' /* put */]
                )(out, value);
              }
            }
          });
        ...
        function mapcatInto(f, ch, bufferOrN) {
          const src = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
          )(bufferOrN);
          __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['b' /* go */]
        ...
        function split(p, ch, trueBufferOrN, falseBufferOrN) {
          const tch = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
          )(trueBufferOrN);
          const fch = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
          )(falseBufferOrN);
          __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['b' /* go */]
        ...
        function map(f, chs, bufferOrN) {
          ...
          const dchan = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
          )(1);
          ...
          const callback = i =>
            value => {
              ...
              if (dcount === 0) {
                __webpack_require__.i(
                  __WEBPACK_IMPORTED_MODULE_3__impl_process__[
                    'g' /* putThenCallback */
                  ]
                )(dchan, values.slice(0));
              }
            };
          ...
          __webpack_require__.i(
            ...
            for (;;) {
              ...
              const _values = yield __webpack_require__.i(
                __WEBPACK_IMPORTED_MODULE_3__impl_process__['b' /* take */]
              )(dchan);
              for (let i = 0; i < length; i += 1) {
                if (
        ...
        function merge(chs, bufferOrN) {
          ...
          __webpack_require__.i(
            ...
            for (;;) {
              ...
              const r = yield __webpack_require__.i(
                __WEBPACK_IMPORTED_MODULE_3__impl_process__['f' /* alts */]
              )(actives);
              const value = r.value;
              if (
                value ===
          ...
          __webpack_require__.i(
            ...
            for (;;) {
              ...
              Object.keys(taps).forEach(id => {
                ...
                )(t.channel, value, makeDoneCallback(t));
              });
        ...
        class Mix {
          constructor(ch) {
            this.ch = ch;
            this.stateMap = {};
            this.change = __webpack_require__.i(
              __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
            )();
        ...
        function mix(out) {
          ...
          __webpack_require__.i(
            ...
            for (;;) {
              const result = yield __webpack_require__.i(
                __WEBPACK_IMPORTED_MODULE_3__impl_process__['f' /* alts */]
              )(state.reads);
              const value = result.value;
              ...
              if (
                ...
                if (
                  ...
                  const stillOpen = yield __webpack_require__.i(
                    __WEBPACK_IMPORTED_MODULE_3__impl_process__['a' /* put */]
                  )(out, value);
                  if (!stillOpen) {
                    break;
        ...
        function pipelineInternal(n, to, from, close, taskFn) {
          ...
          const jobs = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
          )(n);
          const results = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
          )(n);
          ...
          __WEBPACK_IMPORTED_MODULE_0_lodash_times___default()(n, () => {
            __webpack_require__.i(
              ...
              function*(_taskFn, _jobs, _results) {
                for (;;) {
                  const job = yield __webpack_require__.i(
                    __WEBPACK_IMPORTED_MODULE_3__impl_process__['b' /* take */]
                  )(_jobs);
          ...
          __webpack_require__.i(
            ...
            function*(_jobs, _from, _results) {
              for (;;) {
                const v = yield __webpack_require__.i(
                  __WEBPACK_IMPORTED_MODULE_3__impl_process__['b' /* take */]
                )(_from);
          ...
          __webpack_require__.i(
            ...
            function*(_results, _close, _to) {
              for (;;) {
                const p = yield __webpack_require__.i(
                  __WEBPACK_IMPORTED_MODULE_3__impl_process__['b' /* take */]
                )(_results);
                ...
                const res = yield __webpack_require__.i(
                  __WEBPACK_IMPORTED_MODULE_3__impl_process__['b' /* take */]
                )(p);
        ...
        function pipeline(to, xf, from, keepOpen, exHandler) {
          function taskFn(job) {
            ...
            const [v, p] = job;
            const res = __webpack_require__.i(
              __WEBPACK_IMPORTED_MODULE_4__csp_core__['c' /* chan */]
            )(1, xf, exHandler);
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dispatch__ = __webpack_require__(
          4
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__channels__ = __webpack_require__(
          0
        );

        function timeout(msecs) {
          const ch = __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_1__channels__['c' /* chan */]
          )();
          __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_0__dispatch__['a' /* queueDelay */]
          )(() => ch.close(), msecs);
          return ch;
        }
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__csp_operations__ = __webpack_require__(
          10
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_channels__ = __webpack_require__(
          0
        ...
        /* harmony reexport (binding) */ __webpack_require__.d(
          ...
          'CLOSED',
          function() {
            return __WEBPACK_IMPORTED_MODULE_2__impl_channels__['a'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'Channel',
          function() {
            return __WEBPACK_IMPORTED_MODULE_2__impl_channels__['b'];
          }
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__impl_timers__ = __webpack_require__(
          11
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'timeout',
          function() {
            return __WEBPACK_IMPORTED_MODULE_3__impl_timers__['a'];
          }
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__impl_results__ = __webpack_require__(
          6
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'DEFAULT',
          function() {
            return __WEBPACK_IMPORTED_MODULE_4__impl_results__['a'];
          }
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__impl_process__ = __webpack_require__(
          3
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'put',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['a'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'take',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['b'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'offer',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['c'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'poll',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['d'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'sleep',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['e'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'alts',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['f'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'putAsync',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['g'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'takeAsync',
          function() {
            return __WEBPACK_IMPORTED_MODULE_5__impl_process__['h'];
          }
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__csp_core__ = __webpack_require__(
          5
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'spawn',
          function() {
            return __WEBPACK_IMPORTED_MODULE_6__csp_core__['a'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'go',
          function() {
            return __WEBPACK_IMPORTED_MODULE_6__csp_core__['b'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'chan',
          function() {
            return __WEBPACK_IMPORTED_MODULE_6__csp_core__['c'];
          }
        );
        /* harmony reexport (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'promiseChan',
          function() {
            return __WEBPACK_IMPORTED_MODULE_6__csp_core__['d'];
          }
        );

        const operations = {
          mapFrom: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'a' /* mapFrom */
          ],
          mapInto: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'b' /* mapInto */
          ],
          filterFrom: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'c' /* filterFrom */
          ],
          filterInto: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'd' /* filterInto */
          ],
          removeFrom: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'e' /* removeFrom */
          ],
          removeInto: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'f' /* removeInto */
          ],
          mapcatFrom: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'g' /* mapcatFrom */
          ],
          mapcatInto: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'h' /* mapcatInto */
          ],
          pipe: __WEBPACK_IMPORTED_MODULE_1__csp_operations__['i' /* pipe */],
          split: __WEBPACK_IMPORTED_MODULE_1__csp_operations__['j' /* split */],
          reduce: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'k' /* reduce */
          ],
          onto: __WEBPACK_IMPORTED_MODULE_1__csp_operations__['l' /* onto */],
          fromColl: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'm' /* fromColl */
          ],
          ...
          unique: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'q' /* unique */
          ],
          partitionBy: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'r' /* partitionBy */
          ],
          partition: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            's' /* partition */
          ],
          ...
          pipeline: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'w' /* pipeline */
          ],
          pipelineAsync: __WEBPACK_IMPORTED_MODULE_1__csp_operations__[
            'x' /* pipelineAsync */
          ],
        ...
        const buffers = {
          fixed: __WEBPACK_IMPORTED_MODULE_0__impl_buffers__['a' /* fixed */],
          dropping: __WEBPACK_IMPORTED_MODULE_0__impl_buffers__[
            'b' /* dropping */
          ],
          sliding: __WEBPACK_IMPORTED_MODULE_0__impl_buffers__[
            'c' /* sliding */
          ],
          promise: __WEBPACK_IMPORTED_MODULE_0__impl_buffers__[
            'd' /* promise */
          ],
        };
        /* harmony export (immutable) */ __webpack_exports__[
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_get__ = __webpack_require__(
          24
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_get___default = __webpack_require__.n(
          __WEBPACK_IMPORTED_MODULE_0_lodash_get__
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_range__ = __webpack_require__(
          26
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_range___default = __webpack_require__.n(
          __WEBPACK_IMPORTED_MODULE_1_lodash_range__
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_arrayShuffle__ = __webpack_require__(
          16
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_arrayShuffle___default = __webpack_require__.n(
          __WEBPACK_IMPORTED_MODULE_2_lodash_arrayShuffle__
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__boxes__ = __webpack_require__(
          1
        );
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__handlers__ = __webpack_require__(
          7
        );
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__results__ = __webpack_require__(
          6
        );
        ...
        function doAlts(operations, callback, options) {
          ...
          const flag = new __WEBPACK_IMPORTED_MODULE_3__boxes__['a' /* Box */](
            true
          );
          const indexes = __WEBPACK_IMPORTED_MODULE_2_lodash_arrayShuffle___default()(
          ...
          for (let i = 0; i < operations.length; i += 1) {
            ...
            if (
              ...
              ch = operation;
              result = ch.take(
                new __WEBPACK_IMPORTED_MODULE_5__handlers__[
                  'b' /* AltHandler */
                ](flag, value =>
                  callback(
                    new __WEBPACK_IMPORTED_MODULE_6__results__[
                      'b' /* AltResult */
                    ](value, ch)
                  ))
              );
            ...
            if (result) {
              callback(
                new __WEBPACK_IMPORTED_MODULE_6__results__['b' /* AltResult */](
                  result.value,
                  ch
                )
              );
          ...
          if (
            !result &&
            __WEBPACK_IMPORTED_MODULE_0_lodash_get___default()(
              options,
              'default'
            ) &&
            flag.value
            ...
            callback(
              new __WEBPACK_IMPORTED_MODULE_6__results__['b' /* AltResult */](
                options.default,
                __WEBPACK_IMPORTED_MODULE_6__results__['a' /* DEFAULT */]
              )
            );
          }
        }
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        const taskScheduler = (func, value) => {
          __webpack_require__.i(
            __WEBPACK_IMPORTED_MODULE_0__dispatch__['b' /* run */]
          )(() => func(value));
        };
        /* harmony export (immutable) */ __webpack_exports__[
          'b'
 ...
 */
      ...
      /* 23 */
      /***/ function(module, exports, __webpack_require__) {
        var baseRandom = __webpack_require__(18);
 ...
 */
      ...
      /* 26 */
      /***/ function(module, exports, __webpack_require__) {
        var createRange = __webpack_require__(21);
 ...
 */
      ...
      /***/ function(module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function(global, process) {
          ...
          /* WEBPACK VAR INJECTION */
        }.call(exports, __webpack_require__(9), __webpack_require__(29)));
